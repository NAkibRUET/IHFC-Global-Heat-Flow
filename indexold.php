...
<head>
    ...
    <script src='<?=base_url?>js/leaflet.contextmenu.min.js'></script>
        ...
        <div class="row no-gutters">
            ...
            <div class="col-lg-2 col-md-3 col-sm-12">
                <div class="search__areaa srclicolst mobile_block">
                    <div class="">
                        <h5 class="brosiclit">Filterr MAP</h5>
                    </div>
                    <form action="" method="post" id="search_frm">
                        ...
                        <div class="form-group mb-3">
                            <select class="form-control chosen-select" name="grid" id="grid" data-placeholder="Select Year">
                                <option value="">Grids</option>

                                <option value="no" <?php if(isset($_POST['grid']) && $_POST['grid'] == 'no'){ echo 'selected'; }else{ echo 'selected'; }?>>Deactivate</option>
                                <option value="yes" <?php if(isset($_POST['grid']) && $_POST['grid'] == 'yes'){ echo 'selected'; }?>>Activate</option>
                            </select>
                        </div>
